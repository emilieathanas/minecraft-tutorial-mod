...
public class ModEffects {
    ...
    public static final RegistryEntry<StatusEffect> SLIMEY = registerStatusEffect(
            ...
            new SlimeyEffect(StatusEffectCategory.NEUTRAL, 0x36ebab)
                    .addAttributeModifier(EntityAttributes.MOVEMENT_SPEED, Identifier.of(TutorialMod.MOD_ID, "slimey"), -0.25f, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE));
